...
def prepare_wsjmix(datapath, savepath, n_spks=2, skip_prep=True):
    """
...
if __name__ == "__main__":
    wsj0root = "/home/jovyan/wm-insur-call-qa/eric/wsj0/wsj0-mix"
    output_dir = "."
    create_wsj_csv(  wsj0root, output_dir   )
